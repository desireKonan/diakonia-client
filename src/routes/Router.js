...
/** ***** Statistiques ***** */
const MeetingAssemblyDasboard = Loadable(lazy(() => import('../views/main/statistiques/MeetingAssemblyDashboard')));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: '/statistique/rencontre', exact: true, element: <MeetingAssemblyDasboard /> },
