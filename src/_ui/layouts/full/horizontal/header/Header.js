...
import Profile from 'src/_ui/layouts/full/vertical/header/Profile';
import Search from 'src/_ui/layouts/full/vertical/header/Search';
import Navigation from 'src/_ui/layouts/full/vertical/header/Navigation';
