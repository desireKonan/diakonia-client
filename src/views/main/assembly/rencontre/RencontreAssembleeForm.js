...
const RencontreAssembleeForm = ({ rencontre, assemblyId }) => {
    const formik = useFormik({
        initialValues: {
            ...
            adult_count: rencontre && rencontre.details ? rencontre.details['adultCount'] : 0,
            child_count: rencontre && rencontre.details ? rencontre.details['childCount'] : 0,
            guest_count: rencontre && rencontre.details ? rencontre.details['guestCount'] : 0,
            visitor_count: rencontre && rencontre.details ? rencontre.details['visitorCount'] : 0,
            tithe_gift: rencontre && rencontre.details ? rencontre.details['titheAndGift'] : 0,
            attiekoi_gift: rencontre && rencontre.details ? rencontre.details['attiekoiGift'] : 0,
